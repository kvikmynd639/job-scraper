    ...
    <main className="w-full flex flex-col items-center justify-center">
      <div className="relative w-full h-screen">
        ...
        <div className="absolute inset-0">
          <img
            src="/imgs/mercatino-cutie.webp"
            className="object-cover w-full h-full"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-blue-950 via-transparent to-transparent"></div>
        </div>

        {/* Mobile General Jumbotron */}
        <div className="absolute bottom-0 w-full sm:hidden" data-aos="fade-up">
          {/* This will only show on mobile (hidden on small and up) */}
          <div className="flex flex-col items-center gap-6 text-white space-y-2 bg-opacity-50 bg-black p-8">
            <h3 className="text-3xl font-semibold">
              Explore the Future of Job Platforms
            </h3>
            <p className="text-sm mb-2">
              Get started with a personalized experience.
            </p>
        ...
        <div className="absolute bottom-0 w-full hidden sm:block" data-aos="fade-up">
          {/* This will only show on screens medium and up */}
      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4">
          <div
            className="bg-white bg-opacity-10 p-6 rounded-lg text-white shadow-lg transform hover:scale-105 transition-transform"
            data-aos="fade-right"
          >
          ...
          >
            ...
            <p>
              If you don't believe us then try it and see the best match you have for
          ...
          >
            ...
            <p>
              We take care of your invested time so you don't feel stressed out while
              applying. Apply automatically option--
            </p>
          </div>
          <div
            className="bg-white bg-opacity-10 p-6 rounded-lg text-white shadow-lg transform hover:scale-105 transition-transform"
      ...
      <section className="w-full py-12 bg-gradient-to-r from-slate-950 via-slate-950 to-slate-900">
        <div
          className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-4 gap-8"
          data-aos="fade-left"
        >
          ...
          >
            ...
            <p className="text-lg">
              In today's competitive job market, standing out is more important than
              ever. With our platform, you can highlight your unique skills and
              experiences in a way that captures the attention of top employers. Our
              advanced tools and resources are designed to help you build a compelling
              profile, connect with industry professionals, and navigate your career path
              with confidence.
            </p>
            <p className="text-lg">
              Whether you're just starting out or looking to make a career change, our
              platform is here to support you every step of the way. Let us help you
          ...
          >
            <img
              src="/imgs/rocket-launch.png"
              alt="Rocket Launch"
              className="object-fit w-full h-full max-w-md"
            />
          </div>
        </div>
      </section>
